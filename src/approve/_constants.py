...
GENERIC_VALUE_ERROR_MSG: str = "{a!r} = {b!r} does not match expected format. "
ERR_INVALID_REGEX: str = "Regex error while validating {a!r} = {b!r}: {c} "
ERR_COMPILED_REGEX: str = "Expected compiled regex pattern for {a!r}, but got {b!r}. "

MODEL_NUMBER_RULE: str = (
    "Correct {a!r} starts with 2–3 capital letters, followed by 3–4 digits, "
...
BOARD_NAME_RULE: str = (
    "Correct {a!r} starts with a letter, contains only letters, digits, and spaces, "
...
BOARD_SUPPLIER_RULE: str = (
    "Correct {a!r} starts with a capital letter, may contain letters, digits, and spaces, "
    "and should be at least 3 characters long."
)

BOARD_SUPPLIER_PATTERN = re.compile(r'^[A-Z][A-Za-z0-9 ]{2,}$')

BUILD_STAGE_RULE: str = "Correct {a!r} formats are Pn, Pn.n, EBn, EBn.n, MB, MP, ECN, ECNn, TRA, or FOT."

BUILD_STAGE_PATTERN = re.compile(r'^(?:P\d+(?:\.\d+)?|EB\d+(?:\.\d+)?|ECN\d*|MP|MB|TRA|FOT)$')

COST_RULE: str = "Correct {a!r} is a positive number"

COST_PATTERN = re.compile(r'^(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)$')

ITEM_RULE: str = "Correct {a!r} is either empty or a positive integer (e.g., '', '1', '45'). "

ITEM_PATTERN = re.compile(r'^(?:[1-9][0-9]*)?$')

COMPONENT_TYPE_RULE: str = (
    "Correct {a!r} is a string of alphabets with optional spaces "
...
DEVICE_PACKAGE_RULE: str = (
    "Valid {a!r} is either empty or a string that starts and ends with a letter or digit, "
...
DESCRIPTION_RULE: str = (
    "Valid {a!r} must be non-empty and must not contain '*'."
)
DESCRIPTION_PATTERN = re.compile(r'^[^*]+$')

UNITS_RULE: str = (
    "Valid {a!r} is either empty or a string of alphabets with an optional dot "
...
CLASSIFICATION_RULE: str = (
    "Valid {a!r} is a single character: 'A', 'B', or 'C'."
)
...
UL_VDE_NO_RULE: str = (
    "Valid {a!r} may be empty, or start with 1–4 alphabets followed by 1–8 digits, "
...
VALIDATED_AT_RULE: str = (
    "Valid {a!r} is either empty or a list of tokens separated "
...
QUANTITY_RULE: str = (
    "Valid {a!r} is a non-negative number (greater than or equal to zero), "
...
DESIGNATOR_RULE: str = (
    "Valid {a!r} is either empty or a list of tokens separated by ',' "
...
PRICE_RULE: str = (
    "Valid {a!r} is a non-negative number (>= 0). "
